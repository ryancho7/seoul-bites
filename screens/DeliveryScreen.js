  ...
  return (
    <View className="flex-1">
      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        <View 
            style={{backgroundColor: themeColors.bgColor(1.2)}}
            className="p-2 flex-row justify-between items-center rounded-full my-5 mx-2"
        >
            <View className="p-1 rounded-full" style={{backgroundColor: 'rgba(255,255,255,0.4)'}}>
                <Image className="h-16 w-16 rounded-full" source={require('../assets/images/kimDami.jpg')} />
            </View>
            <View className="flex-1 ml-3">
                <Text className="text-lg font-bold text-white">Kim Dami</Text>
                <Text className="font-semibold text-white">Food Delivery</Text>
            </View>
            <View className="flex-row items-center space-x-3 mr-3">
                ...
                <TouchableOpacity onPress={cancelOrder} className="bg-white p-2 rounded-full">
                    <Icon.X fill={themeColors.bgColor(1)} stroke={themeColors.bgColor(1)} strokeWidth={3} />
                </TouchableOpacity>
            </View>
        </View>
      </View>
